...
public class SharedPrefsUtils {
     ...
     */
    public SharedPrefsUtils(Context context, String spFileName) {
        mContext = context;
    ...
    public static void saveStatID(Context context, String id) {
        if (context == null)
            return;
        SharedPrefsUtils sharedPrefsUtil = new SharedPrefsUtils(context, Constant.SharedPrefrence.SHARED_NAME);
        sharedPrefsUtil.setStringSP(Constant.SHARE_PREFS_STATID, id);
    }
    ...
    public static String getStatID(Context context) {
        if (context == null)
            return null;
        SharedPrefsUtils sharedPrefsUtil = new SharedPrefsUtils(context, Constant.SharedPrefrence.SHARED_NAME);
        return sharedPrefsUtil.getStringSP(Constant.SHARE_PREFS_STATID, null);
    }
}
