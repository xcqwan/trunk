...
public class MD5Utils {
     ...
     * @return
     */
    public static String encryptPSW(String userName, String passWord) {
        String psw = MD5Utils.create32Md5(userName + MD5Utils.create32Md5(passWord).toLowerCase());
        return psw.substring(psw.length() - 20).toLowerCase();
    }
